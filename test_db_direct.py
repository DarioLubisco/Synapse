...
try:
    ...
    # Change DB_SERVER in .env to use direct port 49751
    commands = [
        "sed -i 's/DB_SERVER=10.200.8.5\\\\efficacis3/DB_SERVER=10.200.8.5,49751/g' /opt/stacks/synapse-app/Synapse/.env",
